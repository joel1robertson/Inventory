...
public class MainLayout extends AppLayout {
    ...
    public static final String COLUMN_CLASSES = "la la-columns";
    ...
    private NavItemInfo[] createNavMenuItems() {
        return new NavItemInfo[]{ //
                new NavItemInfo("Items", COLUMN_CLASSES, ItemListView.class),
                new NavItemInfo("Item Categories", COLUMN_CLASSES, ItemCategoryAdminView.class),
                new NavItemInfo("Marketplaces", COLUMN_CLASSES, MarketplaceAdminView.class),
                new NavItemInfo("Link Categories", COLUMN_CLASSES, LinkCategoryAdminView.class),
                new NavItemInfo("Prospects", COLUMN_CLASSES, ProspectAdminView.class)
